package rent;
	...
	public class RentalCamera {
		...
		public static void main(String[] args) {
			cameraList.add(new Camera(1, "Sony", "HD214", 400.0, "Available"));
			...
			cameraList.add(new Camera(6, "Samsung", "DS123",500.0, "Available"));
			cameraList.add(new Camera(7, "Sony", "HD226", 500.0, "Available"));
			cameraList.add(new Camera(8, "Sony", "SONY1234", 125.0, "Available"));
			...
			cameraList.add(new Camera(16, "Samsung", "DS246",500.0, "Available"));
			cameraList.add(new Camera(17, "Sony", "DSLR12", 200.0, "Available"));
			cameraList.add(new Camera(18, "Samsung", "SM123", 200.0, "Available"));
			cameraList.add(new Camera(19, "Samsung", "SONY1345", 123.0, "Available"));
			cameraList.add(new Camera(20, "Panasonic", "XC1", 30000.0, "Available"));
			users.add(new User("dhanu", "dhanu123", 10000));
			...
			while (true) {
				...
				try {
					...
					case 5:
						...
						System.exit(0);
					default:
						System.out.println("choice Incorrect. Please try again....");
						break;
					}
